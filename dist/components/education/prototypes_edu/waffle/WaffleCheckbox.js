...
var _androidWCheckboxAndroidJs = require("./android/WCheckboxAndroid.js");

var _androidWCheckboxAndroidJs2 = _interopRequireDefault(_androidWCheckboxAndroidJs);

var WaffleToggle = (function (_React$Component) {
  _inherits(WaffleToggle, _React$Component);

  function WaffleToggle() {
    _classCallCheck(this, WaffleToggle);

    _get(Object.getPrototypeOf(WaffleToggle.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(WaffleToggle, [{
    key: 'render',
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    { title: 'Android' },
                    _react2['default'].createElement(_androidWCheckboxAndroidJs2['default'], null)
                  ),
                  _react2['default'].createElement(
                    _prototypesUbiquityCc2['default'].TabPanel,
                    { title: '' },
