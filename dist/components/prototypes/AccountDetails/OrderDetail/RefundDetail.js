...
var RefundDetail = (function (_React$Component) {
  _inherits(RefundDetail, _React$Component);

  function RefundDetail() {
    _classCallCheck(this, RefundDetail);

    _get(Object.getPrototypeOf(RefundDetail.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(RefundDetail, [{
    key: 'render',
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        _AudibleUITags2['default'].GridColumn,
                        { gridUnits: 2 },
                        _react2['default'].createElement(_AudibleUITags2['default'].Image, { source: 'https://images-na.ssl-images-amazon.com/images/G/01/audibleweb/brickcity/1.0/prototypes/pdp/asin_2._V288437133_.png' })
                      ),
                      _react2['default'].createElement(
                        _AudibleUITags2['default'].GridColumn,
                        { gridUnits: 4 },
