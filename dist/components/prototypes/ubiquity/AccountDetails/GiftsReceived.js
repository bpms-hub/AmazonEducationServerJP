...
var GiftsReceived = (function (_React$Component) {
  _inherits(GiftsReceived, _React$Component);

  function GiftsReceived() {
    _classCallCheck(this, GiftsReceived);

    _get(Object.getPrototypeOf(GiftsReceived.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(GiftsReceived, [{
    key: 'render',
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(_AudibleUITags2['default'].Paragraph, null),
          _react2['default'].createElement(
