...
var Trial_B = (function (_React$Component) {
  _inherits(Trial_B, _React$Component);

  function Trial_B() {
    _classCallCheck(this, Trial_B);

    _get(Object.getPrototypeOf(Trial_B.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(Trial_B, [{
    key: 'render',
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              { gridUnits: 6 },
              _react2['default'].createElement(_AudibleUITags2['default'].Image, { source: 'https://images-na.ssl-images-amazon.com/images/G/01/audibleweb/brickcity/1.0/prototypes/trial/trial_b._V288436985_.jpg' })
            ),
            _react2['default'].createElement(
              _AudibleUITags2['default'].GridColumn,
              { gridUnits: 6, position: 'last', spacingTop: 'extra-large' },
              _react2['default'].createElement(
                _AudibleUITags2['default'].GridRow,
                { textAlign: 'left', spacing: 'small' },
                _react2['default'].createElement(
                  _AudibleUITags2['default'].Text,
                  { textColor: 'base', spacingTop: 'large', textSize: 'large' },
                  'Download any audiobook,',
                  _react2['default'].createElement(
                    _AudibleUITags2['default'].Text,
                    { textBold: true, textEmphasis: true },
                    ' FREE'
                  ),
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  { buttonType: 'primary', inline: false, spacing: 'mini' },
                  'Get My Free Audiobok'
                )
              ),
              _react2['default'].createElement(
                _AudibleUITags2['default'].GridRow,
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(_AudibleUITags2['default'].Image, { imageHeight: '13px', verticalAlign: 'bottom', source: ' https://images-na.ssl-images-amazon.com/images/G/01/audibleweb/brickcity/1.0/icons/amazon_icon._V288488827_.svg' }),
                  _react2['default'].createElement(_AudibleUITags2['default'].LetterSpace, { size: 'mini' }),
                  'account'
                )
              )
          ...
          _react2['default'].createElement(
            ...
            { spacing: 'medium', role: 'main' },
            _react2['default'].createElement(
              _AudibleUITags2['default'].GridRow,
              { spacing: 'small', textAlign: 'center' },
              _react2['default'].createElement(_AudibleUITags2['default'].GridColumn, { gridUnits: 12, position: 'last' })
            ),
            _react2['default'].createElement(
              _AudibleUITags2['default'].GridRow,
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  'After 30 days, Audible is just $14.95/mo. | Don\'t like your book? We\'ll exchange',
                  _react2['default'].createElement('br', null),
                  'it for you. | Cancel anytime—your books are yours to keep.'
                )
              )
            ),
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                      _AudibleUITags2['default'].Text,
                      { textBold: true, textSize: 'mini', textColor: 'secondary' },
...
exports['default'] = Trial_B;
module.exports = exports['default'];
/*Hero Unit*/ /*Great Listen Guarantee*/ /*  <BC.Image imageHeight="60px" source="https://images-na.ssl-images-amazon.com/images/G/01/audibleweb/brickcity/1.0/icons/marketing/icon-marketing-glg._V311706744_.svg" verticalAlign="middle"/>*/