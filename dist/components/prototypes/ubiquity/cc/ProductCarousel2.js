...
var ProductCarousel2 = (function (_React$Component) {
  _inherits(ProductCarousel2, _React$Component);

  function ProductCarousel2(props) {
    _classCallCheck(this, ProductCarousel2);

    _get(Object.getPrototypeOf(ProductCarousel2.prototype), 'constructor', this).call(this, props);
    this.state = {
      itemWidth: null,
      contentWidth: null,
      contentOffset: 0,
  ...
  _createClass(ProductCarousel2, [{
    ...
    value: function componentDidMount() {
      ...
      var itemWidth = (containerWidth - (this.props.carouselAmount - 1) * 20) / this.props.carouselAmount;
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            'div',
            { ref: 'container', className: (0, _classnames2['default'])(["bc-product-carousel-content", this.props.slide ? "bc-product-carousel-slide" : null]),
              style: {
  ...
  return ProductCarousel2;
})(_react2['default'].Component);

ProductCarousel2.PropTypes = {
...
ProductCarousel2.defaultProps = {
  carouselAmount: "4"
};

exports['default'] = ProductCarousel2;
