...
var _androidWButtonsAndroidJs = require("./android/WButtonsAndroid.js");

var _androidWButtonsAndroidJs2 = _interopRequireDefault(_androidWButtonsAndroidJs);

var _reactAddonsCssTransitionGroup = require('react-addons-css-transition-group');

var _reactAddonsCssTransitionGroup2 = _interopRequireDefault(_reactAddonsCssTransitionGroup);

var WaffleButtons = (function (_React$Component) {
  _inherits(WaffleButtons, _React$Component);

  function WaffleButtons() {
    _classCallCheck(this, WaffleButtons);

    _get(Object.getPrototypeOf(WaffleButtons.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(WaffleButtons, [{
    key: 'render',
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                { component: 'div', transitionName: 'fadeIn', transitionAppear: false, transitionLeave: false },
                _react2['default'].createElement(
                  _AudibleUITags2['default'].Box,
                  { background: '#fff', hasBorder: false, paddingSize: 'none', cssClass: 'fadeOut' },
                  _react2['default'].createElement(
                    _prototypesUbiquityCc2['default'].Tabs,
                    { spacingTop: 'base', cssClass: 'bc-edu-tab-heading' },
                    _react2['default'].createElement(
                      _prototypesUbiquityCc2['default'].TabPanel,
                      { title: 'Android' },
                      _react2['default'].createElement(_androidWButtonsAndroidJs2['default'], null)
                    ),
                    _react2['default'].createElement(
                      _prototypesUbiquityCc2['default'].TabPanel,
                      { title: '' },
  ...
  return WaffleButtons;
})(_react2['default'].Component);

exports['default'] = WaffleButtons;
