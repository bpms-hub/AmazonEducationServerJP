...
var _androidWRangeSlidersAndroidJs = require("./android/WRangeSlidersAndroid.js");

var _androidWRangeSlidersAndroidJs2 = _interopRequireDefault(_androidWRangeSlidersAndroidJs);

var WaffleBottomSheet = (function (_React$Component) {
  _inherits(WaffleBottomSheet, _React$Component);

  function WaffleBottomSheet() {
    _classCallCheck(this, WaffleBottomSheet);

    _get(Object.getPrototypeOf(WaffleBottomSheet.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(WaffleBottomSheet, [{
    key: 'render',
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    { title: 'Android' },
                    _react2['default'].createElement(_androidWRangeSlidersAndroidJs2['default'], null)
                  ),
                  _react2['default'].createElement(
                    _prototypesUbiquityCc2['default'].TabPanel,
                    { title: '' },
  ...
  return WaffleBottomSheet;
})(_react2['default'].Component);

exports['default'] = WaffleBottomSheet;
