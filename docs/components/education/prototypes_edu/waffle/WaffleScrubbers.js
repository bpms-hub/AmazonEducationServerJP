...
var _androidWScrubbersAndroidJs = require("./android/WScrubbersAndroid.js");

var _androidWScrubbersAndroidJs2 = _interopRequireDefault(_androidWScrubbersAndroidJs);

var WaffleScrubbers = (function (_React$Component) {
  _inherits(WaffleScrubbers, _React$Component);

  function WaffleScrubbers() {
    _classCallCheck(this, WaffleScrubbers);

    _get(Object.getPrototypeOf(WaffleScrubbers.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(WaffleScrubbers, [{
    key: 'render',
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    { title: 'Android' },
                    _react2['default'].createElement(_androidWScrubbersAndroidJs2['default'], null)
                  ),
                  _react2['default'].createElement(
                    _prototypesUbiquityCc2['default'].TabPanel,
                    { title: '' },
  ...
  return WaffleScrubbers;
})(_react2['default'].Component);

exports['default'] = WaffleScrubbers;
