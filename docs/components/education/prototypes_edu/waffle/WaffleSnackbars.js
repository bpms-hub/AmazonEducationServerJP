...
var _androidWSnackbarsAndroidJs = require("./android/WSnackbarsAndroid.js");

var _androidWSnackbarsAndroidJs2 = _interopRequireDefault(_androidWSnackbarsAndroidJs);

var WaffleSnackbars = (function (_React$Component) {
  _inherits(WaffleSnackbars, _React$Component);

  function WaffleSnackbars() {
    _classCallCheck(this, WaffleSnackbars);

    _get(Object.getPrototypeOf(WaffleSnackbars.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(WaffleSnackbars, [{
    key: 'render',
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    { title: 'Android' },
                    _react2['default'].createElement(_androidWSnackbarsAndroidJs2['default'], null)
                  ),
                  _react2['default'].createElement(
                    _prototypesUbiquityCc2['default'].TabPanel,
                    { title: '' },
  ...
  return WaffleSnackbars;
})(_react2['default'].Component);

exports['default'] = WaffleSnackbars;
