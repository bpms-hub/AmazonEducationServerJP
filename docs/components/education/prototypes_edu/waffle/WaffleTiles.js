...
var _androidWTilesAndroidJs = require("./android/WTilesAndroid.js");

var _androidWTilesAndroidJs2 = _interopRequireDefault(_androidWTilesAndroidJs);

var WaffleTiles = (function (_React$Component) {
  _inherits(WaffleTiles, _React$Component);

  function WaffleTiles() {
    _classCallCheck(this, WaffleTiles);

    _get(Object.getPrototypeOf(WaffleTiles.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(WaffleTiles, [{
    key: 'render',
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    { title: 'Android' },
                    _react2['default'].createElement(_androidWTilesAndroidJs2['default'], null)
                  ),
                  _react2['default'].createElement(
                    _prototypesUbiquityCc2['default'].TabPanel,
                    { title: '' },
