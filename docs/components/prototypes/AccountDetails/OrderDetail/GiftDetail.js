...
var GiftDetail = (function (_React$Component) {
  _inherits(GiftDetail, _React$Component);

  function GiftDetail() {
    _classCallCheck(this, GiftDetail);

    _get(Object.getPrototypeOf(GiftDetail.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(GiftDetail, [{
    key: 'render',
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        _AudibleUITags2['default'].GridColumn,
                        { gridUnits: 2 },
                        _react2['default'].createElement(_AudibleUITags2['default'].Image, { source: 'https://images-na.ssl-images-amazon.com/images/G/01/audibleweb/brickcity/1.0/prototypes/giftcenter/06MonthMembership._V289337813_.svg' })
                      ),
                      _react2['default'].createElement(
                        _AudibleUITags2['default'].GridColumn,
                        { gridUnits: 4 },
                        _react2['default'].createElement(
                          ...
                          'AudibleListener® 6-Month',
                          _react2['default'].createElement('br', null),
                          'Gold Gift Membership'
                        )
                      ),
                      _react2['default'].createElement(
                        _AudibleUITags2['default'].GridColumn,
                        ...
                        _react2['default'].createElement(
                          ...
                          { listType: 'nostyle', spacingTop: 'mini' },
                          _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        _AudibleUITags2['default'].GridColumn,
                        { gridUnits: 1, spacingTop: 'mini', position: 'last' },
                        _react2['default'].createElement(
                          _AudibleUITags2['default'].List,
                          { listType: 'nostyle' },
                          _react2['default'].createElement(
