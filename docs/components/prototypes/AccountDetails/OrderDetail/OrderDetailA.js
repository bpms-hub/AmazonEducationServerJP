...
var OrderDetailA = (function (_React$Component) {
  _inherits(OrderDetailA, _React$Component);

  function OrderDetailA() {
    _classCallCheck(this, OrderDetailA);

    _get(Object.getPrototypeOf(OrderDetailA.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(OrderDetailA, [{
    key: 'render',
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        _AudibleUITags2['default'].GridColumn,
                        { gridUnits: 2 },
                        _react2['default'].createElement(_AudibleUITags2['default'].Image, { source: 'https://images-na.ssl-images-amazon.com/images/G/01/audibleweb/brickcity/1.0/prototypes/pdp/asin_6._V288437133_.png' })
                      ),
                      _react2['default'].createElement(
                        _AudibleUITags2['default'].GridColumn,
                        { gridUnits: 4 },
