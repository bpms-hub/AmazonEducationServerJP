...
var OrderDetailB = (function (_React$Component) {
  _inherits(OrderDetailB, _React$Component);

  function OrderDetailB() {
    _classCallCheck(this, OrderDetailB);

    _get(Object.getPrototypeOf(OrderDetailB.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(OrderDetailB, [{
    key: 'render',
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                      ...
                      _react2['default'].createElement(
                        _AudibleUITags2['default'].GridColumn,
                        { gridUnits: 2 },
                        _react2['default'].createElement(_AudibleUITags2['default'].Image, { source: 'https://images-na.ssl-images-amazon.com/images/G/01/audibleweb/brickcity/1.0/prototypes/pdp/asin_5._V288437133_.png' })
                      ),
                      _react2['default'].createElement(
                        _AudibleUITags2['default'].GridColumn,
                        { gridUnits: 4 },
