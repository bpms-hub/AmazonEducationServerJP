...
var Audiobooks = (function (_React$Component) {
  _inherits(Audiobooks, _React$Component);

  function Audiobooks(props) {
    _classCallCheck(this, Audiobooks);

    _get(Object.getPrototypeOf(Audiobooks.prototype), 'constructor', this).call(this, props);
  }

  _createClass(Audiobooks, [{
    key: 'render',
