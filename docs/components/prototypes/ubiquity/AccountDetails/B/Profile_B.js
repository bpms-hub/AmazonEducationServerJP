...
var Profile_B = (function (_React$Component) {
  _inherits(Profile_B, _React$Component);

  function Profile_B() {
    _classCallCheck(this, Profile_B);

    _get(Object.getPrototypeOf(Profile_B.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(Profile_B, [{
    key: 'render',
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                      _AudibleUITags2['default'].Box,
                      { hasBorder: true, paddingSize: 'base', spacing: 'mini' },
                      _react2['default'].createElement(
                        _AudibleUITags2['default'].GridRow,
...
exports['default'] = Profile_B;
module.exports = exports['default'];
/* Change Password */ /*  <BC.Box backgroundColor="primary" spacing="medium" paddingSize="base" hasBorder={true}>
