...
var MembershipHistory = (function (_React$Component) {
  _inherits(MembershipHistory, _React$Component);

  function MembershipHistory() {
    _classCallCheck(this, MembershipHistory);

    _get(Object.getPrototypeOf(MembershipHistory.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(MembershipHistory, [{
    key: 'render',
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(_AudibleUITags2['default'].Breadcrumbs, { breadcrumbTrail: [{ name: "Account Details", url: "/prototypes/brickcity/account-details" }, { name: "Membership History" }], spacing: 'small' }),
          _react2['default'].createElement(
            _AudibleUITags2['default'].GridRow,
            { spacing: 'base', spacingTop: 'mini' },
            _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  _AudibleUITags2['default'].Heading,
                  { headingLevel: 3, url: '/prototypes/brickcity/gift-center' },
                  'jondough@amazon.com'
                )
              )
            )
