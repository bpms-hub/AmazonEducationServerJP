...
var SubscriptionPreferences = (function (_React$Component) {
  _inherits(SubscriptionPreferences, _React$Component);

  function SubscriptionPreferences() {
    _classCallCheck(this, SubscriptionPreferences);

    _get(Object.getPrototypeOf(SubscriptionPreferences.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(SubscriptionPreferences, [{
    key: 'render',
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  _AudibleUITags2['default'].Paragraph,
                  { spacing: 'base' },
                  'You do not have any active subscriptions. To find out more about our great selection of subscriptions, please visit our ',
                  _react2['default'].createElement(
                    _AudibleUITags2['default'].Link,
                    null,
                    'Newspaper & Magazines'
...
exports['default'] = SubscriptionPreferences;
