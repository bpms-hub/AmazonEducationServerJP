...
var AudibleSoftwarePC3 = (function (_React$Component) {
  _inherits(AudibleSoftwarePC3, _React$Component);

  function AudibleSoftwarePC3() {
    _classCallCheck(this, AudibleSoftwarePC3);

    _get(Object.getPrototypeOf(AudibleSoftwarePC3.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(AudibleSoftwarePC3, [{
    key: 'render',
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(_AudibleUITags2['default'].Breadcrumbs, { breadcrumbTrail: [{ name: "home", url: "/prototypes/brickcity" }, { name: "Download Audio" }], spacing: 'small', spacingTop: 'medium' }),
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  { headingLevel: 3 },
                  'Audible Manager (AM) will begin downloading momentarily.'
                ),
                _react2['default'].createElement(
                  _AudibleUITags2['default'].Paragraph,
                  null,
                  'If AM does not begin downloading in 10 seconds, ',
                  _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    ' and click on the "Download It" button next to your audio'
                  ),
                  _react2['default'].createElement(
                    _AudibleUITags2['default'].ListItem,
                    null,
                    'Once downloaded, you can find your audio in AudibleManager'
                  ),
                  _react2['default'].createElement(
                    _AudibleUITags2['default'].ListItem,
                    null,
                    'Select your audio file and click play'
                  )
                )
              )
            )
  ...
  return AudibleSoftwarePC3;
})(_react2['default'].Component);

exports['default'] = AudibleSoftwarePC3;
