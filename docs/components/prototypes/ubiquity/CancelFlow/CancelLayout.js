...
var CancelLayout = (function (_React$Component) {
  _inherits(CancelLayout, _React$Component);

  function CancelLayout() {
    _classCallCheck(this, CancelLayout);

    _get(Object.getPrototypeOf(CancelLayout.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(CancelLayout, [{
    key: 'render',
