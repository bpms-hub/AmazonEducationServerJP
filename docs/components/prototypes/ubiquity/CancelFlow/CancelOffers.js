...
var CancelOffers = (function (_React$Component) {
  _inherits(CancelOffers, _React$Component);

  function CancelOffers(props, context) {
    _classCallCheck(this, CancelOffers);

    _get(Object.getPrototypeOf(CancelOffers.prototype), 'constructor', this).call(this, props, context);
    this.state = {
      offerSet: this.context.router.getCurrentParams().offerNumber
    };
  }

  _createClass(CancelOffers, [{
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          this.state.offerSet == 1 ? _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                _AudibleUITags2['default'].GridRow,
                { spacing: 'micro' },
                _react2['default'].createElement(_AudibleUITags2['default'].Image, { imageHeight: '60px', source: 'https://images-na.ssl-images-amazon.com/images/G/01/audibleweb/brickcity/1.0/icons/marketing/icon-marketing-switch-inverse._V311706744_.svg' })
              ),
              _react2['default'].createElement(
                _AudibleUITags2['default'].Heading,
          ...
          this.state.offerSet == 1 || this.state.offerSet == 2 ? _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              'div',
              { style: { border: "1px solid #038a91", backgroundColor: "#038a91" } },
              _react2['default'].createElement(
                _AudibleUITags2['default'].GridRow,
                null,
                _react2['default'].createElement(
                  _AudibleUITags2['default'].Text,
                  { textsize: 'mini', textColor: 'inverse', textCapitalize: true },
                  'Most Popular'
                )
              ),
              _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                _AudibleUITags2['default'].Box,
                { backgroundColor: 'base', hasBorder: true, paddingSize: 'medium' },
                _react2['default'].createElement(
                  _AudibleUITags2['default'].GridRow,
                  { heightCss: this.state.offerSet == 2 ? "100px" : "125px" },
                  _react2['default'].createElement(
                    _AudibleUITags2['default'].Paragraph,
                    { spacing: 'medium' },
          ...
          this.state.offerSet == 1 || this.state.offerSet == 2 ? _react2['default'].createElement(
            _AudibleUITags2['default'].GridColumn,
            { gridUnits: this.state.offerSet == 2 ? 6 : 4, spacingTop: 'medium', position: 'last' },
            _react2['default'].createElement(
              _AudibleUITags2['default'].Box,
              { backgroundColor: 'highlight', paddingSize: 'base' },
              _react2['default'].createElement(
