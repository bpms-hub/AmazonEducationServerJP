        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(_cc2['default'].BrowseSearch, { allcategories: true, hasExpander: true })
            ),
            _react2['default'].createElement(
              _AudibleUITags2['default'].FixedGridColumn,
              ...
              _react2['default'].createElement(
                ...
                { backgroundColor: 'inverse', paddingSize: 'medium', heightCss: '120px', spacing: 'large' },
                _react2['default'].createElement(
                  _AudibleUITags2['default'].GridRow,
                  { textSize: 'large', textAlign: 'center', textColor: 'inverse' },
