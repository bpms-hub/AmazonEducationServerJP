...
var CategoryMobile = (function (_React$Component) {
  _inherits(CategoryMobile, _React$Component);

  function CategoryMobile() {
    _classCallCheck(this, CategoryMobile);

    _get(Object.getPrototypeOf(CategoryMobile.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(CategoryMobile, [{
    key: 'render',
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          { url: "/prototypes/brickcity-mobile/category-archive" },
          'Category Name'
        ),
        _react2['default'].createElement(
...
exports['default'] = CategoryMobile;
