...
var LibraryMobile = (function (_React$Component) {
  _inherits(LibraryMobile, _React$Component);

  function LibraryMobile(props) {
    _classCallCheck(this, LibraryMobile);

    _get(Object.getPrototypeOf(LibraryMobile.prototype), 'constructor', this).call(this, props);
  }

  _createClass(LibraryMobile, [{
    key: 'render',
          ...
          _react2['default'].createElement(
            ...
            _dataPrototypesProductsJson2['default'].map(function (product, index) {
              return _react2['default'].createElement(
                ...
                { gridUnits: 6, key: index, spacing: 'base', position: index % 2 === 0 ? 'last' : null },
