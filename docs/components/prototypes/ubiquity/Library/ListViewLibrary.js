...
var ListViewLibrary = (function (_React$Component) {
  _inherits(ListViewLibrary, _React$Component);

  function ListViewLibrary() {
    _classCallCheck(this, ListViewLibrary);

    _get(Object.getPrototypeOf(ListViewLibrary.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(ListViewLibrary, [{
        ...
        productList.map(function (product, index) {
          return _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              { component: 'div', transitionName: 'fadeIn', transitionEnterTimeout: 500, transitionLeave: false },
              this.props.activeBook != index ? _react2['default'].createElement(_Listing2['default'], {
            ...
            _react2['default'].createElement(
              _reactAddonsCssTransitionGroup2['default'],
              { component: 'div', transitionName: 'slideDown', transitionEnterTimeout: 400, transitionLeaveTimeout: 400 },
              this.props.activeBook === index ? _react2['default'].createElement(
                'div',
                { key: 'tray' },
                this.props.ownershipState === 'owned' && _react2['default'].createElement(
                  _Tray2['default'],
                  { trayHeight: 480, onClickTrayClose: this.props.onClickTrayClose },
                  _react2['default'].createElement(_LibraryTrayViews2['default'], { showAsin: true, product: product })
                ),
                this.props.ownershipState === 'preordered' && _react2['default'].createElement(
                  _Tray2['default'],
                  { trayHeight: 480, onClickTrayClose: this.props.onClickTrayClose },
                  _react2['default'].createElement(_PreorderTrayViews2['default'], { showAsin: true, product: product })
                ),
                this.props.ownershipState === 'unowned' && _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(_WishlistTrayViews2['default'], { showAsin: true, product: product })
                )
              ) : null
            )
          );
...
exports['default'] = ListViewLibrary;
