...
var TrialC_Mobile = (function (_React$Component) {
  _inherits(TrialC_Mobile, _React$Component);

  function TrialC_Mobile() {
    _classCallCheck(this, TrialC_Mobile);

    _get(Object.getPrototypeOf(TrialC_Mobile.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(TrialC_Mobile, [{
    key: 'render',
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(_AudibleUITags2['default'].Image, { source: 'https://images-na.ssl-images-amazon.com/images/G/01/audibleweb/brickcity/1.0/prototypes/trial/trial-c-banner._V288436985_.jpg' })
              ),
              _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  _AudibleUITags2['default'].Text,
                  { textColor: 'inverse' },
                  'ProductCarousel Component - Best Sellers'
                )
              ),
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  _AudibleUITags2['default'].Text,
                  { textColor: 'inverse' },
                  'ProductCarousel Component - Get Started'
                )
              )
            ),
            _react2['default'].createElement(
  ...
  return TrialC_Mobile;
})(_react2['default'].Component);

exports['default'] = TrialC_Mobile;
