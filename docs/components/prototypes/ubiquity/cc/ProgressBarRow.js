...
var ProgressBarRow = (function (_React$Component) {
  _inherits(ProgressBarRow, _React$Component);

  function ProgressBarRow() {
    _classCallCheck(this, ProgressBarRow);

    _get(Object.getPrototypeOf(ProgressBarRow.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(ProgressBarRow, [{
    key: 'render',
    value: function render() {
      var staticClasses = ['bc-progressBar-row'];
...
exports['default'] = ProgressBarRow;
