...
var PrototypingLayout = (function (_React$Component) {
  _inherits(PrototypingLayout, _React$Component);

  function PrototypingLayout() {
    _classCallCheck(this, PrototypingLayout);

    _get(Object.getPrototypeOf(PrototypingLayout.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(PrototypingLayout, [{
    key: 'render',
                      ...
                      _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                            ...
                            { app: true, textColor: 'base', url: "/prototypes/brickcity" },
                            'Brick City Desktop'
                          )
                        ),
                        _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                            _AudibleUITags2['default'].Link,
                            { app: true, textColor: 'base', url: "/prototypes/brickcity-mobile" },
                            'Brick City Mobile'
                          )
                        ),
                        _react2['default'].createElement(
                          ...
                          _react2['default'].createElement(
                            _AudibleUITags2['default'].Link,
                            { app: true, textColor: 'base', url: "/prototypes" },
                            'Prototypes'
                          )
                        )
                      )
                    ),
                    _react2['default'].createElement(_AudibleUITags2['default'].AccordionRow, { title: 'Test' })
                  )
                )
              ),
              _react2['default'].createElement(
...
exports['default'] = PrototypingLayout;
