...
var _androidWMenusAndroidJs = require("./android/WMenusAndroid.js");

var _androidWMenusAndroidJs2 = _interopRequireDefault(_androidWMenusAndroidJs);

var WaffleMenus = (function (_React$Component) {
  _inherits(WaffleMenus, _React$Component);

  function WaffleMenus() {
    _classCallCheck(this, WaffleMenus);

    _get(Object.getPrototypeOf(WaffleMenus.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(WaffleMenus, [{
    key: 'render',
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    { title: 'Android' },
                    _react2['default'].createElement(_androidWMenusAndroidJs2['default'], null)
                  ),
                  _react2['default'].createElement(
                    _prototypesUbiquityCc2['default'].TabPanel,
                    { title: '' },
