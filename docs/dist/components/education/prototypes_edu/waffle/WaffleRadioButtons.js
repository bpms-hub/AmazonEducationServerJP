...
var _androidWRadioButtonsAndroidJs = require("./android/WRadioButtonsAndroid.js");

var _androidWRadioButtonsAndroidJs2 = _interopRequireDefault(_androidWRadioButtonsAndroidJs);

var WaffleRadioButtons = (function (_React$Component) {
  _inherits(WaffleRadioButtons, _React$Component);

  function WaffleRadioButtons() {
    _classCallCheck(this, WaffleRadioButtons);

    _get(Object.getPrototypeOf(WaffleRadioButtons.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(WaffleRadioButtons, [{
    key: 'render',
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  ...
                  _react2['default'].createElement(
                    ...
                    { title: 'Android' },
                    _react2['default'].createElement(_androidWRadioButtonsAndroidJs2['default'], null)
                  ),
                  _react2['default'].createElement(
                    _prototypesUbiquityCc2['default'].TabPanel,
                    { title: '' },
  ...
  return WaffleRadioButtons;
})(_react2['default'].Component);

exports['default'] = WaffleRadioButtons;
