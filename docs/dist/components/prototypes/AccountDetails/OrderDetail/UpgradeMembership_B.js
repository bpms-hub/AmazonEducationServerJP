...
var UpgradeMembership_B = (function (_React$Component) {
  _inherits(UpgradeMembership_B, _React$Component);

  function UpgradeMembership_B(props) {
    _classCallCheck(this, UpgradeMembership_B);

    _get(Object.getPrototypeOf(UpgradeMembership_B.prototype), 'constructor', this).call(this, props);
    this.state = {
      activePlan: this.props.active
    };
  }

  _createClass(UpgradeMembership_B, [{
    key: 'choosePlan',
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                              ...
                              _react2['default'].createElement(
                                ...
                                _react2['default'].createElement(
                                  ...
                                  _react2['default'].createElement(
                                    ...
                                    { buttonType: 'disabled', spacing: 'micro' },
                                    ' Current Plan'
                                  )
                                )
                              ),
                                  ...
                                  _react2['default'].createElement(
                                    ...
                                    { modalContent: _react2['default'].createElement(
                                        ...
                                        _react2['default'].createElement(
                                          ...
                                          _react2['default'].createElement(
                                            _AudibleUITags2['default'].Box,
                                            { backgroundColor: 'secondary', hasBorder: false, paddingSize: 'micro', spacing: 'small' },
                                            _react2['default'].createElement(
                                              _AudibleUITags2['default'].Text,
                                              { textBold: true },
                                              'Switch Membership'
                                          ...
                                          _react2['default'].createElement(
                                            ...
                                            _react2['default'].createElement(
                                              ...
                                              _react2['default'].createElement(
                                                _AudibleUITags2['default'].Text,
                                                null,
                                                'You are about to switch your membership plan from AudibleListener® Gold to'
                                              ),
                                              _react2['default'].createElement(
                                                _AudibleUITags2['default'].Text,
                                                { textBold: true },
                                                ' AudibleListenrer® Platinum'
                                              )
                                            ),
                                            _react2['default'].createElement(
                                              _AudibleUITags2['default'].GridRow,
                ...
                _react2['default'].createElement(
                  _ubiquityCc2['default'].TabPanel,
                  { title: 'Orders' },
                  _react2['default'].createElement(_TransactionHistory2['default'], null)
                ),
                _react2['default'].createElement(
                  _ubiquityCc2['default'].TabPanel,
                  { title: 'Preferences' },
  ...
  return UpgradeMembership_B;
})(_react2['default'].Component);

exports['default'] = UpgradeMembership_B;
module.exports = exports['default'];
/* Tab1 - Profile */ /*     <BC.Text  textBold={true}>This Plan Also Includes:</BC.Text>
                      <BC.Paragraph  spacing="small">
                        The ability to rollover up to 12 credits at a time for as long as your membership is active
                                          ...
                                          */ /*  <BC.Text  textBold={true}>This Plan Also Includes:</BC.Text>
                                              <BC.Paragraph  spacing="small">
                                                The ability to rollover up to 12 credits at a time for as long as your membership is active
                                              </BC.Paragraph> */ /*  <BC.Text  textBold={true}>This Plan Also Includes:</BC.Text>
                                                                  <BC.Paragraph  spacing="small">
                                                                    The ability to rollover up to 12 credits at a time for as long as your membership is active
                                                                  </BC.Paragraph> */ /* Tab3 - Billings */ /* Tab4 - Subscriptions */ /* Tab5 - Subscriptions */ /*        <BC.Box backgroundColor="primary" hasBorder={true} paddingSize="small" spacing="base">
