...
var SubCategoryMobile = (function (_React$Component) {
  _inherits(SubCategoryMobile, _React$Component);

  function SubCategoryMobile() {
    _classCallCheck(this, SubCategoryMobile);

    _get(Object.getPrototypeOf(SubCategoryMobile.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(SubCategoryMobile, [{
    key: 'render',
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          { url: "/prototypes/brickcity-mobile/category" },
          'Category Name: Sub Category Name'
        ),
        _react2['default'].createElement(
          _cc2['default'].MobileLink,
          { app: true, url: "/prototypes/brickcity-mobile/sub-category-archive" },
        ...
        _react2['default'].createElement(
          _cc2['default'].MobileLink,
          { app: true, url: "/prototypes/brickcity-mobile/search", hasTopBorder: true, hideBottomBorder: true },
          'Browse all in Sub Category Name'
        ),
  ...
  return SubCategoryMobile;
})(_react2['default'].Component);

exports['default'] = SubCategoryMobile;
