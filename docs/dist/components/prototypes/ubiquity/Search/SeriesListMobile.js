...
var SeriesListMobile = (function (_React$Component) {
  _inherits(SeriesListMobile, _React$Component);

  function SeriesListMobile(props) {
    _classCallCheck(this, SeriesListMobile);

    _get(Object.getPrototypeOf(SeriesListMobile.prototype), 'constructor', this).call(this, props);
  }

  _createClass(SeriesListMobile, [{
    key: 'renderSeriesList',
    value: function renderSeriesList() {
      var rows = [];
  ...
  return SeriesListMobile;
})(_react2['default'].Component);

exports['default'] = SeriesListMobile;
