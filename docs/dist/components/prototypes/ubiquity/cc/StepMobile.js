...
var StepMobile = (function (_React$Component) {
  _inherits(StepMobile, _React$Component);

  function StepMobile() {
    _classCallCheck(this, StepMobile);

    _get(Object.getPrototypeOf(StepMobile.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(StepMobile, [{
    key: 'render',
    value: function render() {
      var staticClasses = ['bc-stepMobile'];
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement('div', _extends({}, this.props, {
          className: (0, _classnames2['default'])('bc-stepMobile-text') }))
      );
    }
  }]);
