...
import WRadioButtonsAndroid from "./android/WRadioButtonsAndroid.js";



class WaffleRadioButtons extends React.Component{
  render() {
    return (
...
export default WaffleRadioButtons;
