...
import WRangeSlidersAndroid from "./android/WRangeSlidersAndroid.js";



class WaffleBottomSheet extends React.Component{
  render() {
    return (
...
export default WaffleBottomSheet;
