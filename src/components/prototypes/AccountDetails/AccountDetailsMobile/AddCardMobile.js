...
class AddCardMobile extends React.Component {
  render() {
    return (
      <div>
        <ProdHeaderMobile/>
        ...
        <CC.MobilePageTitle textAlign="center" first={true} url={"/prototypes/brickcity-mobile/account-details/billing"}>
          <BC.Text textColor="base">Add Card</BC.Text>
        </CC.MobilePageTitle>
          ...
          <BC.Section spacingTop="base" textAlign="left">
            ...
            <BC.GridRow spacing="mini">
              <BC.GridColumn gridUnits={12} >
                <BC.Heading headingLevel={3} hasBold={true} spacing="micro">Credit Card Number</BC.Heading>
            ...
            <BC.GridRow spacing="mini">
              <BC.GridColumn gridUnits={6}>
                ...
                <BC.TextInput placeholder="10003"></BC.TextInput>
              </BC.GridColumn>
            </BC.GridRow>
            ...
            <BC.GridRow spacing="base">
              <BC.GridColumn gridUnits={12} >
                ...
                <BC.TextInput placeholder="1234567890"></BC.TextInput>
              </BC.GridColumn>
            </BC.GridRow>
