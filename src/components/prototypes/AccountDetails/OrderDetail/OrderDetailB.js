...
class OrderDetailB extends React.Component {
          ...
          <BC.GridColumn gridUnits={12} position="last" spacingTop="micro">
              <CC.Tabs tabActive={3}>
                ...
                <BC.GridRow spacing="small">
                      ...
                      <BC.Image source="https://images-na.ssl-images-amazon.com/images/G/01/audibleweb/brickcity/1.0/prototypes/pdp/asin_5._V288437133_.png" />
                        </BC.GridColumn>
                      <BC.GridColumn gridUnits={4} >
