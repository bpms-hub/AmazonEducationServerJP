...
class UpgradeMembership_B extends React.Component {
...
choosePlan(element){
        ...
        <div className="bc-container">
          ...
          <BC.GridColumn gridUnits={12} position="last" spacingTop="micro">
              <CC.Tabs tabActive={1}>
                ...
                <BC.Link linkType="nav" url={"/prototypes/brickcity/account-details-b"}>Back to Overview</BC.Link>
                  </BC.GridRow>
                      ...
                      <BC.Button buttonType="disabled" spacing="micro"> Current Plan</BC.Button>
                                        ...
                                        <BC.GridColumn gridUnits={3}>
                                          <CC.Card spacing="base"
                                            ...
                                            <BC.ModalTrigger modalContent={<div>

                                              <BC.GridRow textAlign="left">

                                                <BC.Box backgroundColor="secondary" hasBorder={false} paddingSize="micro" spacing="small">
                                                  <BC.Text textBold={true}>Switch Membership</BC.Text>
                                                </BC.Box>
                                                <BC.GridColumn gridUnits={12}>
                                                <BC.GridRow spacing="small">
                                                  <BC.Text>You are about to switch your membership plan from AudibleListener® Gold to</BC.Text>
                                                    <BC.Text textBold={true}> AudibleListenrer® Platinum</BC.Text>
                                                    </BC.GridRow>
                                                      <BC.GridRow spacing="base">
                                                          <BC.Text spacing="base"> Your new monthly charge will be</BC.Text>  <BC.Text spacing="base" textBold={true}> $22.95</BC.Text>
                                                </BC.GridRow>
                                                <BC.GridRow textAlign="left">
                                                  <BC.GridColumn gridUnits={3} gridPush={5}>
                                                    <BC.Button buttonType="secondary" inline={false} app={true} url={"/prototypes/brickcity/cancel/success-cancel"}>Cancel</BC.Button>
                                                  </BC.GridColumn>
                                                  <BC.GridColumn gridUnits={4} position="last">
                                                      <BC.Button buttonType="primary" inline={false} app={true} url={"/prototypes/brickcity/upgrade-membership_b"}>Confirm Switch</BC.Button>
                                                      </BC.GridColumn>
                                                </BC.GridRow>
                                      </BC.GridColumn>
                                      </BC.GridRow>
                                              ...
                                              <BC.Button buttonType="primary" spacing="micro">Switch</BC.Button>
                                            </BC.ModalTrigger>
                                  ...
                                  <BC.Paragraph spacing="micro" textBold={true} textSize="base">
  ...
  {  /*        <BC.Box backgroundColor="primary" hasBorder={true} paddingSize="small" spacing="base">
              <BC.Heading headingLevel={2} spacing="small" textColor="base">Cancel Membership</BC.Heading>
              <BC.Divider spacing="small"/>
...
export default UpgradeMembership_B;
