...
class CancelOffersB extends React.Component {
  ...
  render() {
    ...
    return (
      <CancelLayout>
        <BC.Heading spacing="micro">We hear you</BC.Heading>
        ...
        <BC.GridRow textAlign="center" spacing="medium">
          { this.state.offerSet == 1 ?
            <BC.GridColumn gridUnits={4}>
              <BC.Box backgroundColor="highlight" paddingSize="base" hasBorder={true}>
                <BC.GridRow spacing="micro">
                  <BC.Image imageHeight="60px" source="https://images-na.ssl-images-amazon.com/images/G/01/audibleweb/brickcity/1.0/icons/marketing/icon-marketing-switch-inverse._V311720857_.svg" />
                </BC.GridRow>

                <BC.Heading headingLevel={2} spacing="mini" textColor="inverse">Spend Less, Savor More</BC.Heading>
              </BC.Box>
          ...
          { this.state.offerSet == 1 || this.state.offerSet == 2 ?
            <BC.GridColumn gridUnits={this.state.offerSet == 2 ? 6 : 4} position="last">
              <BC.Box backgroundColor="highlight" paddingSize="base" hasBorder={true}>
                <BC.GridRow spacing="micro">
