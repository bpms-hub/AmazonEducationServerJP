...
class ProductCarousel2 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      itemWidth: null,
  ...
  componentDidMount() {
    ...
    let itemWidth = (containerWidth-((this.props.carouselAmount-1)*20)) / (this.props.carouselAmount)
    ...
    return (
      <BC.GridRow spacing="base">
        ...
        <BC.GridRow cssClass="bc-product-carousel-container" spacing="mini">
            <div ref="container" className={classNames(["bc-product-carousel-content", this.props.slide ? "bc-product-carousel-slide" : null])}
              style={{
