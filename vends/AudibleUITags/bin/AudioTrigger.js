  ...
  _createClass(AudioTrigger, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        'span',
        { className: (0, _classnames2['default'])(staticClasses), onClick: this.props.onClick },
        _react2['default'].createElement(
          'span',
          { className: 'bc-audio-trigger-cta' },
          this.props.isLoading ? [_react2['default'].createElement(_AudibleUITags2['default'].Image, { cssClass: 'bc-audio-trigger-spinner', block: true, imageHeight: 33, imageWidth: 33, source: '/test.svg' })] : [_react2['default'].createElement(_AudibleUITags2['default'].Icon, { iconType: !this.props.isPlaying ? 'play' : 'pause', textColor: 'inverse', verticalAlign: 'middle' })]
        ),
...
AudioTrigger.propTypes = {
  ...
  triggerType: _react.PropTypes.string,
  isPlaying: _react.PropTypes.boolean,
  hasCountdown: _react.PropTypes.boolean
};
