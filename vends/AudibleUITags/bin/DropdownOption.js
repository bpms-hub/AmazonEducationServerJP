...
var DropdownOption = (function (_React$Component) {
  _inherits(DropdownOption, _React$Component);

  function DropdownOption(props) {
    _classCallCheck(this, DropdownOption);

    _get(Object.getPrototypeOf(DropdownOption.prototype), 'constructor', this).call(this, props);
  }

  _createClass(DropdownOption, [{
    key: 'render',
    value: function render() {
      var staticClasses = ['bc-color-base'];
