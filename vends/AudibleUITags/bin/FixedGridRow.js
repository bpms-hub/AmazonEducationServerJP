...
var FixedGridRow = (function (_React$Component) {
  _inherits(FixedGridRow, _React$Component);

  function FixedGridRow(props) {
    _classCallCheck(this, FixedGridRow);

    _get(Object.getPrototypeOf(FixedGridRow.prototype), 'constructor', this).call(this, props);
  }

  _createClass(FixedGridRow, [{
    key: 'render',
    value: function render() {
      var staticClasses = ['bc-fixed-grid-' + this.props.fixedColumn];
...
FixedGridRow.propTypes = {
  ...
  fixedColumnWidth: _react.PropTypes.number.isRequired,
