...
var GridColumn = (function (_React$Component) {
	...
	function GridColumn(props) {
		...
		_get(Object.getPrototypeOf(GridColumn.prototype), 'constructor', this).call(this, props);
	}

	_createClass(GridColumn, [{
		key: 'render',
		value: function render() {
			var staticClasses = ['bc-col'];
...
GridColumn.propTypes = {
	...
	gridUnits: _react.PropTypes.number,
	gridPush: _react.PropTypes.number,
	gridPull: _react.PropTypes.number,
