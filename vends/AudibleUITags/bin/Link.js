	...
	_createClass(Link, [{
		...
		value: function render() {
			...
			if (this.props.disabled) {
				staticClasses.push('bc-disabled');
			}
			...
			if (this.props.app) {
				return _react2['default'].createElement(
					_reactRouter.Link,
					_extends({}, this.props, { id: this.props.id, className: (0, _classnames2['default'])(staticClasses), onClick: this.props.disabled ? this.onClickDisabled.bind(this) : this.props.onClick, to: this.props.url, params: this.props.params, query: this.props.query, title: this.props.title, disabled: this.props.disabled, rel: this.props.rel }),
					this.props.children
				);
			} else {
				return _react2['default'].createElement(
					'a',
					_extends({}, this.props, { id: this.props.id, className: (0, _classnames2['default'])(staticClasses), onClick: this.props.disabled ? this.onClickDisabled.bind(this) : this.props.onClick, href: this.props.url, title: this.props.title, target: this.props.target, disabled: this.props.disabled, rel: this.props.rel }),
					this.props.children
				);
			}
		}
