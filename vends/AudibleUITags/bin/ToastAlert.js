...
var ToastAlert = (function (_React$Component) {
  _inherits(ToastAlert, _React$Component);

  function ToastAlert(props) {
    _classCallCheck(this, ToastAlert);

    _get(Object.getPrototypeOf(ToastAlert.prototype), 'constructor', this).call(this, props);
  }

  _createClass(ToastAlert, [{
    key: 'render',
    value: function render() {
      var staticClasses = ['bc-alert-toast'];
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(_Icon2['default'], { iconType: 'close', textColor: 'inverse' })
        )
      );
    }
  }]);
